...
This guide walks through the core DeepLens workflow: loading a lens, computing PSFs, rendering images, and configuring the default wavelength and depth settings used across the API.
...
lens.draw_layout(save_name="./lens_layout.png")  # save a cross-section of the lens
```
...
- [API Reference](api/index.md) — full documentation for all classes
