...
**Script:** [`5_pupil_field.py`](https://github.com/vccimaging/DeepLens/blob/main/5_pupil_field.py)
...
- [HybridLens design](design_hybridlens.md) · API: [`ComplexWave`](../api/core.md#light)
