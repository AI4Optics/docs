...
**Script:** [`9_diffractive_surfaces.py`](https://github.com/vccimaging/DeepLens/blob/main/9_diffractive_surfaces.py)
...
- [Phase Surfaces API](../api/core.md#phase-surfaces) · [4f system](4f_system.md)
